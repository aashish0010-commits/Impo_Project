...
function Header() {
  ...
  return (
    <>
      {/* Top Contact Section */}
      <section className="fixed top-0 left-0 w-full bg-customDark z-40 md:hidden">
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center py-1 text-xs px-4 md:px-12">
          ...
          <div className="text-white md:py-0 py-2">
            <ul className="flex flex-row md:gap-3 gap-6">
              ...
              <Link
                href="#"
                className="border border-transparent p-1 rounded-md bg-white text-black hover:bg-customSecondary hover:text-white flex items-center justify-center text-center gap-2 transition-colors duration-500 ease-in-out"
              >
      ...
      {/* Main Header Section */}
      <section className="fixed md:top-[0px] top-[50px] left-0 w-full bg-white shadow-md z-30">
        <div className="container mx-auto md:py-1 py-3 md:px-12 px-8 flex justify-between items-center text-sm">
          ...
          <div className="hidden md:flex flex-grow justify-end items-center gap-7">
            ...
            <Link
              href="/appointment" // Replace this with the path to your desired page
        ...
        >
          <div className="flex flex-col p-5 text-customDark">
            ...
            <Link
              href="/schedule" // Replace this with the path to your desired page
              className="p-3 rounded-md bg-customDark text-white hover:bg-customSecondary text-xs transition-colors duration-500 ease-in-out"
            >
              <i className="bi bi-calendar2-minus-fill pr-2"></i>
              Book an Appointment
